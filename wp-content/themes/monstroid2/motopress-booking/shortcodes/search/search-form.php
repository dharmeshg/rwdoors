...
<form method="GET" class="mphb_sc_search-form loading" action="<?php echo $action; ?>">
	...
	<div class="mphb_sc_search-check-in-date">
		<div class="showing-form">
			...
			<div class="date h4-style">
				<span class="on-load-label"><?php esc_html_e( 'Check-in Date', 'monstroid2' ); ?></span>
		...
		<div class="hidden-form">
			...
			<br />
			<input id="<?php echo esc_attr( 'mphb_check_in_date-' . $uniqid ); ?>" data-datepick-group="<?php echo esc_attr( $uniqid ); ?>" value="<?php echo esc_attr( $checkInDate ); ?>" placeholder="<?php esc_attr_e( 'Check-in Date', 'monstroid2' ); ?>" required="required" type="text" name="mphb_check_in_date" class="mphb-datepick mphb_check_in_date" autocomplete="off" />
		</div>
	</div>
	...
	<div class="mphb_sc_search-check-out-date">
		<div class="showing-form">
			...
			<div class="date h4-style">
				<span class="on-load-label"><?php esc_html_e( 'Check-out Date', 'monstroid2' ); ?></span>
				<span class="day h1-style"></span><span class="month"></span> <span class="year"></span>
			</div>
		</div>
		<div class="hidden-form">
			...
			<br />
			<input id="<?php echo esc_attr( 'mphb_check_out_date-' . $uniqid ); ?>" data-datepick-group="<?php echo esc_attr( $uniqid ); ?>" value="<?php echo esc_attr( $checkOutDate ); ?>" placeholder="<?php esc_attr_e( 'Check-out Date', 'monstroid2' ); ?>" required="required" type="text" name="mphb_check_out_date" class="mphb-datepick mphb_check_out_date" autocomplete="off"/>
		</div>
	</div>
	...
	<div class="mphb_sc_search-submit-button-wrapper">
		<input type="submit" class="button" value="<?php esc_attr_e( 'Check Availability', 'monstroid2' ); ?>"/>
	</div>
