	...
	return apply_filters( 'monstroid2_get_customizer_options' , array(
		...
		'options'    => array(
			...
			'top_menu_visibility' => array(
				'title'           => esc_html__( 'Show top menu', 'monstroid2' ),
				'section'         => 'header_top_panel',
				'default'         => true,
				'field'           => 'checkbox',
				'type'            => 'control',
			...
			'header_search' => array(
				'title'   => esc_html__( 'Show search', 'monstroid2' ),
			...
			'footer_layout_type' => array(
				...
				'default' => 'default',
				'field'   => 'select',
				'choices' => monstroid2_get_footer_layout_options(),
				'type' => 'control',
			),
			'footer_bg' => array(
 ...
 * @return array
 */
function monstroid2_get_footer_layout_options() {
	return apply_filters( 'monstroid2_footer_layout_options', array(
		'default' => esc_html__( 'Style 1', 'monstroid2' ),
		'style-2' => esc_html__( 'Style 2', 'monstroid2' ),
	) );
}
 ...
 * @return array
 */
function monstroid2_get_footer_layout_pm_options() {
	$inherit_option = array(
		'inherit' => esc_html__( 'Inherit', 'monstroid2' ),
	);

	$options = monstroid2_get_footer_layout_options();
...
function monstroid2_get_skins_style_settings() {
	return apply_filters( 'monstroid2_skins_style_options', array(
		...
		'skin10' => array(
			...
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin10/style-skin10.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin10/assets/css/dynamic-skin10.css',
		),
		'skin11' => array(
			'label'       => esc_html__( 'IntraBrand', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin11/style-skin11.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin11/assets/css/dynamic-skin11.css',
		),
		'skin12' => array(
			'label'       => esc_html__( 'Lingua', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin12/style-skin12.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin12/assets/css/dynamic-skin12.css',
		),
		'skin13' => array(
			'label'       => esc_html__( 'MarieJuliette', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin13/style-skin13.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin13/assets/css/dynamic-skin13.css',
		),
	) );
}
...
function monstroid2_get_dynamic_css_options() {
	return apply_filters( 'monstroid2_get_dynamic_css_options', array(
		'prefix'        => 'monstroid2',
		'type'          => 'theme_mod',
		'parent_handle' => 'monstroid2-skin-style',
		'single'        => true,
		'css_files'     => array(
			...
			MONSTROID2_THEME_DIR . '/assets/css/dynamic/plugins/motopress-booking.css',
			MONSTROID2_THEME_DIR . '/assets/css/dynamic/plugins/polylang.css',
			MONSTROID2_THEME_DIR . '/assets/css/dynamic/plugins/tm-photo-gallery.css',
 ...
 */
function monstroid2_customize_preview_js() {
	wp_enqueue_script( 'monstroid2-customize-preview', MONSTROID2_THEME_JS . '/customize-preview.js', array( 'customize-preview' ), '1.0', true );
}
add_action( 'customize_preview_init', 'monstroid2_customize_preview_js' );
