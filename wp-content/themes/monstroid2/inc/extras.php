 ...
 */
add_filter( 'theme_mod_header_btn_visibility', 'monstroid2_pre_set_post_meta_value' );
 ...
 * Footer layout type
 */
add_filter( 'theme_mod_footer_layout_type', 'monstroid2_set_post_meta_value' );

/**
 * Enable/disable footer widget area
 */
add_filter( 'theme_mod_footer_widget_area_visibility', 'monstroid2_pre_set_post_meta_value' );

/**
 * Enable/disable footer contact block
 */
add_filter( 'theme_mod_footer_contact_block_visibility', 'monstroid2_pre_set_post_meta_value' );
...
function monstroid2_set_post_meta_value( $value ) {
	$queried_obj = monstroid2_get_queried_obj();
 ...
 */
function monstroid2_get_queried_obj() {
...
function monstroid2_hex_color_is_light_or_dark( $color ) {
 ...
 return apply_filters( 'monstroid2_hex_color_is_light_or_dark', $is_light_or_dark, $color ) ;
}
 ...
 */
function monstroid2_404_inline_css() {
