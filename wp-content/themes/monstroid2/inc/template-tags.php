...
function monstroid2_header_logo() {
	$type = get_theme_mod( 'header_logo_type', monstroid2_theme()->customizer->get_default( 'header_logo_type' ) );
	$logo = monstroid2_get_site_title_by_type( $type );
...
function monstroid2_is_top_panel_visible() {
	...
	$woo_elements             = monstroid2_is_woocommerce_activated() && get_theme_mod( 'header_woo_elements', monstroid2_theme()->customizer->get_default( 'header_woo_elements' ) );
