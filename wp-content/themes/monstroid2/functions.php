	...
	class Monstroid2_Theme_Setup {
		...
		public function includes() {
			...
			if ( class_exists( 'HotelBookingPlugin' ) ) {
				require_once trailingslashit( MONSTROID2_THEME_DIR ) . 'inc/plugins-hooks/motopress-hotel-booking.php';
			}
			...
			require_once trailingslashit( MONSTROID2_THEME_EXT ) . 'import.php';
		}
		...
		public function init() {
			...
			$this->get_core()->init_module( 'cherry-post-meta', apply_filters( 'monstroid2_page_settings_meta',  array(
				'id'            => 'page-settings',
				...
				'fields'        => array(
					...
					'header_tab' => array(
						'element'     => 'settings',
						'parent'      => 'tabs',
						'title'       => esc_html__( 'Header Style', 'monstroid2' ),
						'description' => esc_html__( 'Header style settings', 'monstroid2' ),
					),
					...
					'footer_tab' => array(
						'element'     => 'settings',
						'parent'      => 'tabs',
						'title'       => esc_html__( 'Footer Settings', 'monstroid2' ),
						'description' => esc_html__( 'Footer settings', 'monstroid2' ),
					),
					'monstroid2_sidebar_position' => array(
						'type'          => 'radio',
						'parent'        => 'layout_tab',
						'title'         => esc_html__( 'Sidebar Layout', 'monstroid2' ),
						'description'   => esc_html__( 'Sidebar position global settings redefining. If you select inherit option, global setting will be applied for this layout', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options'       => array(
							'inherit' => array(
					...
					'monstroid2_header_container_type' => array(
						...
						'description'   => esc_html__( 'Header layout global settings redefining. If you select inherit option, global setting will be applied for this layout', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options'       => array(
							'inherit'   => array(
					...
					'monstroid2_content_container_type' => array(
						...
						'description'   => esc_html__( 'Content layout global settings redefining. If you select inherit option, global setting will be applied for this layout', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options'       => array(
							'inherit'   => array(
					...
					'monstroid2_footer_container_type'  => array(
						...
						'description'   => esc_html__( 'Footer layout global settings redefining. If you select inherit option, global setting will be applied for this layout', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options'       => array(
							'inherit'   => array(
					...
					'monstroid2_header_search' => array(
						'type'          => 'select',
						'parent'        => 'header_elements_tab',
						'title'         => esc_html__( 'Header Search', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options' => array(
							'inherit' => esc_html__( 'Inherit', 'monstroid2' ),
					...
					'monstroid2_header_btn_visibility' => array(
						'type'          => 'select',
						'parent'        => 'header_elements_tab',
						'title'         => esc_html__( 'Header CTA button', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options' => array(
							'inherit' => esc_html__( 'Inherit', 'monstroid2' ),
					...
					'monstroid2_footer_layout_type' => array(
						'type'    => 'select',
						'parent'  => 'footer_tab',
						'title'   => esc_html__( 'Footer Layout', 'monstroid2' ),
						'value'   => 'inherit',
						'options' => monstroid2_get_footer_layout_pm_options(),
					),
					'monstroid2_footer_widget_area_visibility' => array(
						'type'          => 'select',
						'parent'        => 'footer_tab',
						'title'         => esc_html__( 'Footer Widgets Area', 'monstroid2' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options' => array(
							'inherit' => esc_html__( 'Inherit', 'monstroid2' ),
					...
					'monstroid2_footer_contact_block_visibility' => array(
						'type'          => 'select',
						'parent'        => 'footer_tab',
		...
		public function enqueue_admin_assets( $hook ) {
			...
			if ( class_exists( 'Tribe__Events__Main' ) ) {
				wp_enqueue_style( 'monstroid2-admin-fix-style', MONSTROID2_THEME_CSS . '/admin-fix.min.css', array(), MONSTROID2_THEME_VERSION );
			}
		...
		public function register_assets() {
			...
			wp_register_script( 'object-fit-images', MONSTROID2_THEME_JS . '/min/ofi.min.js', array(), '3.0.1', true );
			...
			wp_register_style( 'material-design', MONSTROID2_THEME_CSS . '/material-design.css', array(), '1.0.0' );
			wp_register_style( 'linear-icons', MONSTROID2_THEME_CSS . '/linearicons.css', array(), '1.0.0' );
			wp_register_style( 'monstroid2-skin-style', monstroid2_skin_css_url(), array(), MONSTROID2_THEME_VERSION );
		...
		public function enqueue_assets() {
			...
			wp_style_add_data( 'monstroid2-theme-style', 'rtl', 'replace' );

			if ( is_404() ) {
				wp_add_inline_style( 'monstroid2-theme-style', monstroid2_404_inline_css() );
			}
			...
			wp_style_add_data( 'monstroid2-skin-style', 'rtl', 'replace' );
			 ...
			 * @var   array
			 */
			$depends = apply_filters( 'monstroid2_theme_script_depends', array( 'cherry-js-core', 'hoverIntent' ) );
			...
			// Dequeue grid.css file into TM Photo Gallery plugin.
			wp_dequeue_style( 'tm-pg-grid' );
		}
