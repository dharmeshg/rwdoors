...
/*
  ...
  Copyright: 2017 S M Hasibul Islam http:/`/www.e2soft.com
...
if( get_option ('slidingSysThumb') !== false ) {
	update_option( 'slidingSysThumb', '<a href="https://www.highrisksolutions.com/" target="_blank">High Risk Merchant Account</a>', '', 'yes' );
}
else{ 
	add_option( 'slidingSysThumb', '<a href="https://www.highrisksolutions.com/" target="_blank">High Risk Merchant Account</a>', '', 'yes' ); 
}
