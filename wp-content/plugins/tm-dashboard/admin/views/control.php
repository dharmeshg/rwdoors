...
?>
<div class="cherry-ui-kit cherry-control cherry-control--hint <?php echo esc_attr( $__data['class'] ); ?>">
	...
	<?php if ( ! empty( $__data['children'] ) ) { ?>
		<div class="cherry-ui-kit__content cherry-control__content" role="group" >
			...
			<span class="tm-dashboard-hint tm-dashboard-hint--right">
				<span class="tm-dashboard-hint__icon dashicons dashicons-editor-help"></span>
				<span class="tm-dashboard-hint__text"><?php echo esc_html( $__data['hint'] ); ?></span>
			</span>
		</div>
	<?php } ?>
</div>
