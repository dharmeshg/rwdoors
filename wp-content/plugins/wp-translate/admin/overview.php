...
<div id='wrap'>
	...
	<div class="wpt-divider first"><h1><?php _e('WP Translate', 'wptranslate'); ?></h1></div>
	...
	<p><strong><a href="http://plugingarden.com/google-translate-wordpress-plugin/" target="_blank"><?php _e('Upgrade to WP Translate Pro', 'wp-translate'); ?></a> - $9</strong><br /><em><?php _e('Pro features include: Improved look and feel, enhanced widget positioning, and more', 'wp-translate'); ?>...</em></p>
	</div>
	<div class="wp-translate-settings-wrap">
	...
	<div id="wpt-right-column">
        ...
        <div class="wp-translate-settings-wrap">                
			...
			<p><a href="http://plugingarden.com/?src=wpt" target="_blank"><img src="http://plugingarden.com/wp-content/uploads/2017/08/CustomPostDonationsPro-200x400v4.png" width="200" height="400" alt="Custom Post Donations Pro" border="0"></a></p>
